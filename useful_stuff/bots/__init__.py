...
from .pre_bots__ import MyBotA, MyBotB

__all__ = ["RandBot", "AlphaBetaBot", "RdeepBot", "MLDataBot", "MLPlayingBot", "train_ML_model", "SchnapsenServer", "MiniMaxBot", "MyBot", "MyBotA", "MyBotB"]